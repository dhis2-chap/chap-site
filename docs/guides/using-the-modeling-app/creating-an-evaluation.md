...
![Evaluations page with New evaluation button](images/creating-an-evaluation/eval-step-1-navigate.png)
...
![Name input field](images/creating-an-evaluation/eval-step-2-name.png)
...
![Period configuration with type and date range](images/creating-an-evaluation/eval-step-3-period.png)
...
![Organization unit selection modal](images/creating-an-evaluation/eval-step-4-orgunits.png)
...
![Model selection modal](images/creating-an-evaluation/eval-step-5-model.png)
...
![Data mapping configuration modal](images/creating-an-evaluation/eval-step-6-mapping.png)
...
![Form summary and submit buttons](images/creating-an-evaluation/eval-step-7-submit.png)
